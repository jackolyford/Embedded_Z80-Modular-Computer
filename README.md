...
The Zilog z80 cpu was chosen due to it's simplicity compared to modern systems and ability to assemble easily using through-hole components on a prototyping board. As the main purpose of this project was to learn and get used to microcomputer systems, having a separate IC for the cpu, memory and IO controller greatly influenced this choice. 
